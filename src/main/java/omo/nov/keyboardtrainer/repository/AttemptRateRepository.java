...
public interface AttemptRateRepository extends JpaRepository<AttemptRate, UUID> {
    ...
    List<AttemptRate> findAllByContestIdAndUser_StatusAndFalseLetterCountLessThanAndOrderByCommonTrueDesc(Long contest_id, Boolean user_status, Integer falseLetterCount);
